...
import com.grkicbreport.repository.DokRepository;
import com.grkicbreport.repository.KreditRepository;
import com.grkicbreport.repository.SaldoRepository;
...
public class NumdogCorrectService {
    ...
    public File getNumdog(LocalDate startDate, LocalDate endDate, String numdog) {
