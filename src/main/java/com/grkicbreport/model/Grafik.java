...
public class Grafik {
    ...
    public Grafik(LocalDate dats, BigDecimal pogKred, BigDecimal pogProc, BigDecimal ostatok, Byte mes, Byte sost, String numdog, Kredit kredit) {
        this.dats = dats;
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof Grafik)) return false;
        final Grafik other = (Grafik) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof Grafik;
    }
    ...
    public String toString() {
        return "Grafik(dats=" + this.getDats() + ", pogKred=" + this.getPogKred() + ", pogProc=" + this.getPogProc() + ", ostatok=" + this.getOstatok() + ", mes=" + this.getMes() + ", sost=" + this.getSost() + ", numdog=" + this.getNumdog() + ", kredit=" + this.getKredit() + ")";
    }
}
